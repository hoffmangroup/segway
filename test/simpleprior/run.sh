...
SEGWAY_RAND_SEED=1498730685 segway "$cluster_arg" \
    ...
    --prior-strength=1 \
    "../simpleprior.genomedata" traindir

segway "$cluster_arg" train-run-round \
    "../simpleprior.genomedata" traindir

cd ..

python${SEGWAY_TEST_PYTHON_VERSION:-""} ../compare_directory.py ../simpleprior/touchstone ../simpleprior/${testdir#"./"}
