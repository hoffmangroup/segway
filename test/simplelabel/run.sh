...
SEGWAY_RAND_SEED=1498730685 segway "$cluster_arg" \
    ...
    --structure="../simplelabel.str" --max-train-rounds=1 \
    "../simplelabel.genomedata" traindir

segway "$cluster_arg" identify --include-coords="../include-coords.bed" \
    "../simplelabel.genomedata" traindir identifydir

cd ..

python${SEGWAY_TEST_PYTHON_VERSION:-""} ../compare_directory.py ../simplelabel/touchstone ../simplelabel/${testdir#"./"}
