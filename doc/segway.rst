...
To identify, run Segway from the same directory you ran the train task above
...
You must run identify from the same directory from where the train task was
